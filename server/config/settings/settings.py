...
if DEBUG:
    ...
    def show_toolbar(request):  # noqa: E303
        from django.conf import settings
        return settings.DEBUG


    DEBUG_TOOLBAR_CONFIG = {  # noqa: E303
...
# created vshagur@gmail.com, 2021-07-27
SIMPLE_JWT_SIGNING_KEY = "b=72^ado*%1(v3r7rga9ch)03xr=d*f)lroz94kosf!61((9=i"

SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=45) if DEBUG else timedelta(seconds=10),
